...
const TodoUpdateModal = ({ id }) => {
  ...
  const singleTodo = todos.find((item) => item.id === id);
  ...
  const handleFormSubmit = (e) => {
    ...
    const newTodo = {
      id,
      title: task,
      description: description || singleTodo?.description,
      priority: priority || singleTodo?.priority,
    };
